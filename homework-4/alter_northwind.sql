...
DELETE FROM order_details WHERE product_id IN (SELECT product_id FROM order_details EXCEPT
SELECT product_id FROM products) "удаление записей в order_details, которых нет в products по айди продукта"
